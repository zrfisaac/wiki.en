...
## Description
Software is a collection of programs, data, and instructions that enable a computer to perform specific tasks. It includes system software, such as operating systems, application software for user tasks, and development tools for programming.
...
- [Debug](#debug)
  - Window Detective :
    [`i386-setup`](https://sourceforge.net/projects/windowdetective/files/release-3.5.1/Window-Detective-3.5.1-setup.exe/download)
    [`i386-source`](https://sourceforge.net/projects/windowdetective/files/release-3.5.1/Window-Detective-3.5.1-src.zip/download)
    [`i386-sourceforge`](https://sourceforge.net/projects/windowdetective/)
...
### [Window Detective](#index)
[`i386-setup`](https://sourceforge.net/projects/windowdetective/files/release-3.5.1/Window-Detective-3.5.1-setup.exe/download)
[`i386-source`](https://sourceforge.net/projects/windowdetective/files/release-3.5.1/Window-Detective-3.5.1-src.zip/download)
[`i386-sourceforge`](https://sourceforge.net/projects/windowdetective/)
[`amd64-github`](https://github.com/lihas/WindowDetective)

<img src="picture\software-window-detective.png">
